...
class ExcelHelper {
  ...
  static async writeInquiryPLNToExcel(datas) {
    ...
    for (const data of datas) {
      ...
      const stan_meter = detail ? detail.stan_meter : "";
  ...
  static async writePaymentPLNToExcel(datas) {
    ...
    for (const data of datas) {
      ...
      const payment_date = moment(data.payment_date).format(
        "YYYY-MM-DD HH:mm:ss"
      );
      worksheet.addRow({
        transaction_id,
  ...
  static async writePaymentPLNPrepaidToExcel(datas) {
    ...
    worksheet.columns = [
      ...
      { header: "No Meter", key: "no_meter", width: 10 },
    ...
    for (const data of datas) {
      ...
      const no_meter = detail ? detail.no_meter : "";
      const payment_date = moment(data.payment_date).format(
        "YYYY-MM-DD HH:mm:ss"
      );
      const sn = detail ? detail.sn : "";
  ...
  static async writePaymentPrepaidToExcel(datas) {
    const workbook = new ExcelJs.Workbook();
    const worksheet = workbook.addWorksheet("Payment");
    worksheet.columns = [
      { header: "Transaction ID", key: "transaction_id", width: 10 },
  ...
  static async writeInquiryPDAMToExcel(datas) {
    const workbook = new ExcelJs.Workbook();
    const worksheet = workbook.addWorksheet("Inquiry");
    worksheet.columns = [
      { header: "Transaction ID", key: "transaction_id", width: 10 },
  ...
  static async writePaymentPDAMToExcel(datas) {
    const workbook = new ExcelJs.Workbook();
    const worksheet = workbook.addWorksheet("Inquiry");
    worksheet.columns = [
      { header: "Transaction ID", key: "transaction_id", width: 10 },
  ...
  static async writeInquiryPostpaidToExcel(datas) {
    const workbook = new ExcelJs.Workbook();
    const worksheet = workbook.addWorksheet("Inquiry");
    worksheet.columns = [
      { header: "Transaction ID", key: "transaction_id", width: 10 },
  ...
  static async writeInquiryPBBToExcel(datas) {
    const workbook = new ExcelJs.Workbook();
    const worksheet = workbook.addWorksheet("Inquiry");
    worksheet.columns = [
      { header: "Transaction ID", key: "transaction_id", width: 10 },
